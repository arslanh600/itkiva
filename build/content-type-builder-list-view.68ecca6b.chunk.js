"use strict";(self.webpackChunkiktva_strapi_api=self.webpackChunkiktva_strapi_api||[]).push([[5905],{57134:(Oe,J,d)=>{d.r(J),d.d(J,{default:()=>We});var e=d(67294),c=d(95489),b=d(41363),n=d(28702),de=d(27361),C=d.n(de),pe=d(18721),me=d.n(pe),ue=d(18446),Q=d.n(ue),ge=d(11700),Y=d.n(ge),D=d(97132),S=d(25741),fe=d(45697),o=d.n(fe),q=d(26478),F=d(13588),h=d(71893),y=d(5002);const ye=(0,h.default)(n.Flex)`
  border-radius: 50%;
...
`;function W({component:t,dzName:a,index:l,isActive:i,isInDevelopmentMode:p,onClick:r}){const{modifiedData:u,removeComponentFromDynamicZone:x}=(0,F.Z)(),{schema:{displayName:T}}=C()(u,["components",t],{schema:{}}),E=g=>{g.stopPropagation(),x(a,l)};return e.createElement(he,{as:"button",alignItems:"center",direction:"column",className:i?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,type:"button",onClick:r},e.createElement(U,{isActive:i}),e.createElement(n.Box,{marginTop:1,maxWidth:"100%"},e.createElement(n.Typography,{variant:"pi",fontWeight:"bold",ellipsis:!0},T)),p&&e.createElement(_,{as:"button",onClick:E,type:"button"},e.createElement(b.Cross,null)))}W.defaultProps={component:null,isActive:!1,isInDevelopmentMode:!1,onClick(){}},W.propTypes={component:o().string,dzName:o().string.isRequired,index:o().number.isRequired,isActive:o().bool,isInDevelopmentMode:o().bool,onClick:o().func};const be=W,ee=h.default.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`;function V({customRowComponent:t,component:a,isFromDynamicZone:l,isNestedInDZComponent:i,firstLoopComponentUid:p}){const{modifiedData:r}=(0,F.Z)(),{schema:{attributes:u}}=C()(r,["components",a],{schema:{attributes:[]}});return e.createElement(ee,{isChildOfDynamicZone:l,className:"component-row"},e.createElement("td",{colSpan:12},e.createElement(oe,{customRowComponent:t,items:u,targetUid:a,firstLoopComponentUid:p||a,editTarget:"components",isFromDynamicZone:l,isNestedInDZComponent:i,isSub:!0,secondLoopComponentUid:p?a:null})))}V.defaultProps={component:null,customRowComponent:null,firstLoopComponentUid:null,isFromDynamicZone:!1,isNestedInDZComponent:!1},V.propTypes={component:o().string,customRowComponent:o().func,firstLoopComponentUid:o().string,isFromDynamicZone:o().bool,isNestedInDZComponent:o().bool};const te=V,Ee=(0,h.default)(b.Plus)`
...
`,ae=t=>e.createElement(Be,null,e.createElement(Ze,{width:"20",height:"23",viewBox:"0 0 20 23",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},e.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.02477 14.7513C8.65865 17.0594 11.6046 18.6059 17.5596 18.8856C18.6836 18.9384 19.5976 19.8435 19.5976 20.9688V20.9688C19.5976 22.0941 18.6841 23.0125 17.5599 22.9643C10.9409 22.6805 6.454 20.9387 3.75496 17.1258C0.937988 13.1464 0.486328 7.39309 0.486328 0.593262H4.50974C4.50974 7.54693 5.06394 11.9813 7.02477 14.7513Z"})));ae.propTypes={color:o().string.isRequired};const De=ae,j=({content:t})=>Y()(t);j.defaultProps={content:null},j.propTypes={content:o().string};const Fe=j,Le=(0,h.default)(n.Box)`
  position: relative;
`;var Ie=d(68314);const H=({type:t,customField:a,repeatable:l})=>{const{formatMessage:i}=(0,D.useIntl)();let p=t;return["integer","biginteger","float","decimal"].includes(t)?p="number":["string"].includes(t)&&(p="text"),a?e.createElement(n.Typography,null,i({id:(0,y.Z)("attribute.customField"),defaultMessage:"Custom field"})):e.createElement(n.Typography,null,i({id:(0,y.Z)(`attribute.${p}`),defaultMessage:t}),"\xA0",l&&i({id:(0,y.Z)("component.repeatable"),defaultMessage:"(repeatable)"}))};H.defaultProps={customField:null,repeatable:!1},H.propTypes={type:o().string.isRequired,customField:o().string,repeatable:o().bool};const Ae=H;function K({configurable:t,customField:a,editTarget:l,firstLoopComponentUid:i,isFromDynamicZone:p,name:r,onClick:u,relation:x,repeatable:T,secondLoopComponentUid:E,target:g,targetUid:s,type:m}){const{contentTypes:f,isInDevelopmentMode:B,removeAttribute:k}=(0,F.Z)(),{formatMessage:w}=(0,D.useIntl)(),v=m==="relation"&&x.includes("morph"),M=["integer","biginteger","float","decimal"].includes(m)?"number":m,Z=C()(f,[g],{}),L=C()(Z,["schema","displayName"],""),I=C()(Z,"plugin"),G=g?"relation":M,A=()=>{v||t!==!1&&u(l,E||i||s,r,m,a)};let R;return E&&i?R=2:i?R=1:R=0,e.createElement(Le,{as:"tr",...(0,c.onRowClick)({fn:A,condition:B&&t&&!v})},e.createElement("td",{style:{position:"relative"}},R!==0&&e.createElement(De,{color:p?"primary200":"neutral150"}),e.createElement(n.Flex,{paddingLeft:2,gap:4},e.createElement(Ie.Z,{type:G,customField:a}),e.createElement(n.Typography,{fontWeight:"bold"},r))),e.createElement("td",null,g?e.createElement(n.Typography,null,w({id:(0,y.Z)(`modelPage.attribute.${v?"relation-polymorphic":"relationWith"}`),defaultMessage:"Relation with"}),"\xA0",e.createElement("span",{style:{fontStyle:"italic"}},e.createElement(Fe,{content:L}),"\xA0",I&&`(${w({id:(0,y.Z)("from"),defaultMessage:"from"})}: ${I})`)):e.createElement(Ae,{type:m,customField:a,repeatable:T})),e.createElement("td",null,B?e.createElement(n.Flex,{justifyContent:"flex-end",...c.stopPropagation},t?e.createElement(n.Flex,{gap:1},!v&&e.createElement(n.IconButton,{onClick:A,label:`${w({id:"app.utils.edit",defaultMessage:"Edit"})} ${r}`,noBorder:!0,icon:e.createElement(b.Pencil,null)}),e.createElement(n.IconButton,{onClick:P=>{P.stopPropagation(),k(l,r,E||i||"")},label:`${w({id:"global.delete",defaultMessage:"Delete"})} ${r}`,noBorder:!0,icon:e.createElement(b.Trash,null)})):e.createElement(b.Lock,null)):e.createElement(n.Box,{height:(0,c.pxToRem)(32)})))}K.defaultProps={configurable:!0,customField:null,firstLoopComponentUid:null,isFromDynamicZone:!1,onClick(){},relation:"",repeatable:!1,secondLoopComponentUid:null,target:null,targetUid:null,type:null},K.propTypes={configurable:o().bool,customField:o().string,editTarget:o().string.isRequired,firstLoopComponentUid:o().string,isFromDynamicZone:o().bool,name:o().string.isRequired,onClick:o().func,relation:o().string,repeatable:o().bool,secondLoopComponentUid:o().string,target:o().string,targetUid:o().string,type:o().string};const Pe=(0,e.memo)(K),Ne=t=>{let a;switch(t){case"date":case"datetime":case"time":case"timestamp":a="date";break;case"integer":case"biginteger":case"decimal":case"float":a="number";break;case"string":case"text":a="text";break;case"":a="relation";break;default:a=t}return a},Se={collectionTypesConfigurations:[{action:"plugin::content-manager.collection-types.configure-view",subject:null}],componentsConfigurations:[{action:"plugin::content-manager.components.configure-layout",subject:null}],singleTypesConfigurations:[{action:"plugin::content-manager.single-types.configure-view",subject:null}]},X=({disabled:t,isTemporary:a,isInContentTypeView:l,contentTypeKind:i,targetUid:p})=>{const{formatMessage:r}=(0,D.useIntl)(),{push:u}=(0,S.useHistory)(),{collectionTypesConfigurations:x,componentsConfigurations:T,singleTypesConfigurations:E}=Se,g=r({id:"content-type-builder.form.button.configure-view"});let s=x;const m=()=>(a||u(l?`/content-manager/collectionType/${p}/configurations/edit`:`/content-manager/components/${p}/configurations/edit`),!1);return l&&i==="singleType"&&(s=E),l||(s=T),e.createElement(c.CheckPermissions,{permissions:s},e.createElement(n.Button,{startIcon:e.createElement(b.Layer,null),variant:"tertiary",onClick:m,disabled:a||t},g))};X.defaultProps={contentTypeKind:"collectionType",isInContentTypeView:!0,isTemporary:!1,targetUid:""},X.propTypes={disabled:o().bool.isRequired,contentTypeKind:o().string,isInContentTypeView:o().bool,isTemporary:o().bool,targetUid:o().string};const Ue=(0,e.memo)(X),We=()=>{const{initialData:t,modifiedData:a,isInDevelopmentMode:l,isInContentTypeView:i,submitData:p}=(0,F.Z)(),{formatMessage:r}=(0,D.useIntl)(),{trackUsage:u}=(0,c.useTracking)(),x=(0,S.useRouteMatch)("/plugins/content-type-builder/:kind/:currentUID"),{onOpenModalAddComponentsToDZ:T,onOpenModalAddField:E,onOpenModalEditField:g,onOpenModalEditSchema:s,onOpenModalEditCustomField:m}=(0,q.Z)(),f=i?"contentType":"component",B=[f,"schema","attributes"],k=C()(a,[f,"uid"]),w=C()(a,[f,"isTemporary"],!1),v=C()(a,[f,"schema","kind"],null),M=C()(a,B,[]),Z=me()(t,[f,"plugin"]),L=!Q()(a,t),I=i?"contentType":"component",G=$=>{T({dynamicZoneTarget:$,targetUid:k})},A=async($,le,re,ie,se)=>{const ce=Ne(ie);se?m({forTarget:$,targetUid:le,attributeName:re,attributeType:ce,customFieldUid:se}):g({forTarget:$,targetUid:le,attributeName:re,attributeType:ce,step:ie==="component"?"2":null})};let R=C()(a,[f,"schema","displayName"],"");const P=C()(a,[f,"schema","kind"],""),N=x?.params.currentUID==="create-content-type";!R&&N&&(R=r({id:(0,y.Z)("button.model.create"),defaultMessage:"Create new collection type"}));const Ve=()=>{const $=P||f;$==="collectionType"&&u("willEditNameOfContentType"),$==="singleType"&&u("willEditNameOfSingleType"),s({modalType:f,forTarget:f,targetUid:k,kind:$})};return e.createElement(e.Fragment,null,e.createElement(S.Prompt,{message:r({id:(0,y.Z)("prompt.unsaved")}),when:L}),e.createElement(n.HeaderLayout,{id:"title",primaryAction:l&&e.createElement(n.Flex,{gap:2},!N&&e.createElement(n.Button,{startIcon:e.createElement(b.Plus,null),variant:"secondary",onClick:()=>{E({forTarget:I,targetUid:k})}},r({id:(0,y.Z)("button.attributes.add.another")})),e.createElement(n.Button,{startIcon:e.createElement(b.Check,null),onClick:()=>p(),type:"submit",disabled:Q()(a,t)},r({id:"global.save",defaultMessage:"Save"}))),secondaryAction:l&&!Z&&!N&&e.createElement(n.Button,{startIcon:e.createElement(b.Pencil,null),variant:"tertiary",onClick:Ve},r({id:"app.utils.edit",defaultMessage:"Edit"})),title:Y()(R),subtitle:r({id:(0,y.Z)("listView.headerLayout.description"),defaultMessage:"Build the data architecture of your content"}),navigationAction:e.createElement(c.Link,{startIcon:e.createElement(b.ArrowLeft,null),to:"/plugins/content-type-builder/"},r({id:"global.back",defaultMessage:"Back"}))}),e.createElement(n.ContentLayout,null,e.createElement(n.Flex,{direction:"column",alignItems:"stretch",gap:4},e.createElement(n.Flex,{justifyContent:"flex-end"},e.createElement(n.Flex,{gap:2},e.createElement(Ue,{key:"link-to-cm-settings-view",targetUid:k,isTemporary:w,isInContentTypeView:i,contentTypeKind:v,disabled:N}))),e.createElement(n.Box,{background:"neutral0",shadow:"filterShadow",hasRadius:!0},e.createElement(oe,{items:M,customRowComponent:$=>e.createElement(Pe,{...$,onClick:A}),addComponentToDZ:G,targetUid:k,editTarget:I,isMain:!0})))))}}}]);
